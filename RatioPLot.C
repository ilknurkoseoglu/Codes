...
*/     
	...
	pad2->cd();
	 ...
	 TH1F *Signal3_Clone =(TH1F*)Signal3->Clone("Signal3_Clone");    
         ...
         Signal1_Clone->SetFillColorAlpha(46,0.80);
 ...
 Signal1_Clone->SetLineWidth(2);
  ...
  for (Int_t i=1; i< Signal1_Clone->GetNbinsX(); i++)
	...
	Signal1_Clone->Draw("e2");
	Signal3_Clone->Draw("same e2");
	l->Draw();  
   ...
   // Signal3->SetStats(0);
    ...
    c1->SaveAs("SR0_Method/SR0_50PU_ML1_"+sigbck+variable+"_"+method+"_.pdf");
    c1->SaveAs("SR0_Method/SR0_50PU_ML1_"+sigbck+variable+"_"+method+"_.root");	
    c1->SaveAs("SR0_Method/SR0_50PU_ML1_"+sigbck+variable+"_"+method+"_.png");
